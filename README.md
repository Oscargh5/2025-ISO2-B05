...
se asume realizada la fase de requisitos para la iteración 2 en el lado del servidor
...
Se asume realizada la fase de Testing para la iteración 2 en la componente del servidor
